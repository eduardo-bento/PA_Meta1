...
public class ProposalAttributionLockState extends ContextAdapter {
    public ProposalAttributionLockState(Context context, Data data) {
        super(context, data);
    }
    ...
    public EState getState() {
        return EState.PROPOSALS_PHASE_LOCK;
    }
}
